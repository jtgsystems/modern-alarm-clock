    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="relative overflow-hidden rounded-xl p-6 backdrop-blur-sm">
        ...
        <div className="relative space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="volume" className="text-white/80">
              Alarm Volume
            </Label>
            <div className="flex items-center gap-3 px-1">
              ...
              <Slider
                ...
                className="flex-grow"
              />
              <span className="text-white/60 text-sm tabular-nums w-9">{volume}%</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-white/50">Get popup notifications when the alarm triggers</p>
            </div>
            <Switch
              id="notifications"
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="recurring" className="text-white/80">
              Recurring Alarm
            </Label>
            <Switch
              id="recurring"
